...
/***/ function(module, exports, __webpack_require__) {
	...
	var marked = __webpack_require__(157);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        "div",
	        { className: "app" },
	        React.createElement(List, { title: "To Do", cards: this.props.cardsList.filter(function (card) {
	  ...
	  _createClass(Card, [{
	    ...
	    value: function render() {
	      ...
	      if (this.state.showDetails) {
	        cardDetails = React.createElement(
	          "div",
	          { className: "card__details" },
	          React.createElement("span", { dangerouslySetInnerHTML: { __html: marked(this.props.description) } }),
	          React.createElement(CheckList, { tasks: this.props.tasks })
	        );
	      }
	      var sideColor = {
	        position: 'absolute',
	      ...
	      return React.createElement(
	        "div",
	        { className: "card" },
	        React.createElement("div", { style: sideColor }),
	        React.createElement(
	          "div",
	...
	var CheckList = (function (_React$Component5) {
	  _inherits(CheckList, _React$Component5);
	  ...
	  _createClass(CheckList, [{
	    ...
	    value: function render() {
	      var tasks = this.props.tasks.map(function (task) {
	        return React.createElement(Task, { key: task.id, name: task.name, done: task.done });
	      });
	      return React.createElement(
	        "div",
	        { className: "checklist" },
	  ...
	  _createClass(Task, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement("input", { type: "checkbox", defaultChecked: this.props.done }),
	        this.props.name,
	...
	var cardsList = [{
	  ...
	  color: '#3A7E28',
	  status: "todo",
	  tasks: [{ id: 1, name: "ContactList Example", done: true }, { id: 2, name: "Kanban Example", done: false }, { id: 3, name: "My own experiments", done: false }]
	}];

	React.render(React.createElement(App, { cardsList: cardsList }), document.getElementById('app'));
